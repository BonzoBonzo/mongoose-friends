...
var Friendship = {
  ...
  status: {
    type: String, 
    enum: Object.keys(Status).map(function (key) { return Status[key] }) 
  },
  ...
  return function friends (schema) {
    ...
    schema.statics.getFriends = function (model) {
      ...
      resolveArgs(arguments, function (conditions, fields, options, cb) {
        ...
        var elemMatch = Object.keys(conditions).reduce(function (o, k) {
          var match;
          if (match = k.match(rx)) {
    ...
    schema.statics.areFriends = function (m1, m2, cb) {
      ...
      var getFriendship = friendshipBetween(m1, m2).bind(this);
...
/**
 * Expose the Friendship schema as a property of the plugin
 */
plugin.Friendship = Friendship;
